...
def scraped_to_official():
    ...
    if macro_run:
        ...
        print("Finished!    ------ BUT!! Must run excel Macro CopySheetsFromScrapedData manually from visual basic in 1Ingreso_gasto_fincanc_sector_publico.xlsm .")
...
if to_download:
    ...
    print("-- Open needed table: example 1.3.15S -- > 1 means first tab in 2nd row i.e. Ingreso, gasto y financiamieto del sector público, 3 means 3rd tab of 3rd row i.e. Gastos Presupuestarios, 15 means 15th available table i.e. Principales Beneficiarios de Transferencias del Gobierno Federal Calsifición Funcional.")
    ...
    print("-- Replace in test.xlsm with the appropriate sheet name i.e. 1.3.15S")
