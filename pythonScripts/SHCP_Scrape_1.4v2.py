...
if to_download:
    ...
    print("-- Open needed table: example 1.4.3S -- > 1 means first tab in 2nd row i.e. Ingreso, gasto y financiamieto del sector público, 4 means 4th tab of 3rd row i.e. Situación Financiera por Secto y Entidad, 3 means 3rd available table i.e. III. Situación Financiera del Gobierno Federal y Seguridad Social.")
    ...
    print("-- Replace in test.xlsm with the appropriate sheet name i.e. 1.4.3S")
