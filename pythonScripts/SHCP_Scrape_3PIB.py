# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 15:05:26 2020
...
def store(df_dict):   
    ...
    print("Data was stored in test3.xlsm")
...
if to_download:
    ...
    print("-- Open needed table: example 3.2.4PIB -- > 3 means first tab in 2nd row i.e. Requerimientos Financieros el Sector Público, 2 means 2nd tab of 3rd row i.e. Sector Gobierno Central, 4 means 4th available table i.e. Requerimientos Financieros de Otros del Sector Gobierno Central.")
    ...
    print("-- Replace in test3.xlsm with the appropriate sheet name i.e. 3.2.4PIB")
    print("-- Save and close test3.xlsm")  