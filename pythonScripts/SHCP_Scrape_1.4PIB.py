...
def scraped_to_official():
    ...
    if macro_run:
        ...
        print("Finished!    ------ BUT!! Must run excel Macros CopyPIBSheets4FromScrapedData and textToNumber manually from visual basic in 1Ingreso_gasto_fincanc_sector_publico.xlsm.")
...
if to_download:
    ...
    print("-- Open needed table: example 1.4.3PIB -- > 1 means first tab in 2nd row i.e. Ingreso, gasto y financiamieto del sector público, 4 means 4th tab of 3rd row i.e. Situación Financiera por Secto y Entidad, 3 means 3rd available table i.e. III. Situación Financiera del Gobierno Federal y Seguridad Social.")
    ...
    print("-- Replace in test.xlsm with the appropriate sheet name i.e. 1.4.3PIB")
